...
<script type="text/html" id="tribe_tmpl_month_mobile_day_header">
	<div class="tribe-mobile-day" data-day="[[=date]]">[[ if(date_name.length) { ]]
		<h3 class="tribe-mobile-day-heading"><?php printf( __( '%s for', 'the-events-calendar' ), tribe_get_event_label_plural() ); ?> <span>[[=raw date_name]]</span></h3>[[ } ]]
	</div>
</script>
...
<script type="text/html" id="tribe_tmpl_month_mobile">
	<div class="tribe-events-mobile hentry vevent tribe-clearfix tribe-events-mobile-event-[[=eventId]][[ if(categoryClasses.length) { ]] [[= categoryClasses]][[ } ]]">
		...
		<div class="tribe-events-event-body">
			...
			[[ } ]]
			<a href="[[=permalink]]" class="tribe-events-read-more" rel="bookmark"><?php esc_html_e( 'Find out more', 'the-events-calendar' ); ?> &raquo;</a>
		</div>
	</div>
</script>