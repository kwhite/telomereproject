...
class WP_Widget_Custom_Advertisement extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your advertisement', 'econature') 
		);
		...
		parent::__construct('custom-advertisement', __('Advertisement', 'econature'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Advertisement', 'econature') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image1'); ?>"><?php _e('Image', 'econature'); ?> #1:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link1'); ?>"><?php _e('Link', 'econature'); ?> #1:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image2'); ?>"><?php _e('Image', 'econature'); ?> #2:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link2'); ?>"><?php _e('Link', 'econature'); ?> #2:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image3'); ?>"><?php _e('Image', 'econature'); ?> #3:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link3'); ?>"><?php _e('Link', 'econature'); ?> #3:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image4'); ?>"><?php _e('Image', 'econature'); ?> #4:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link4'); ?>"><?php _e('Link', 'econature'); ?> #4:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image5'); ?>"><?php _e('Image', 'econature'); ?> #5:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link5'); ?>"><?php _e('Link', 'econature'); ?> #5:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image6'); ?>"><?php _e('Image', 'econature'); ?> #6:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link6'); ?>"><?php _e('Link', 'econature'); ?> #6:<br />
...
class WP_Widget_Custom_Contact_Info extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('name'); ?>"><?php _e('Name', 'econature'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>" type="text" value="<?php echo $address; ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('city'); ?>"><?php _e('City', 'econature'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('state'); ?>"><?php _e('State', 'econature'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('zip'); ?>"><?php _e('Zip', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('zip'); ?>" name="<?php echo $this->get_field_name('zip'); ?>" type="text" value="<?php echo $zip; ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('phone'); ?>"><?php _e('Phone', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('phone'); ?>" name="<?php echo $this->get_field_name('phone'); ?>" type="text" value="<?php echo $phone; ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email', 'econature'); ?>:<br />
...
class WP_Widget_Custom_Divider extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Divider for widgets rows', 'econature') 
		);
		
		parent::__construct('custom-divider', __('Divider', 'econature'), $widget_ops);
	}
	...
	function form($instance) {
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('divider'); ?>"><?php _e('Show Divider Line', 'econature'); ?></label>
		</p>
        <p>
            <label for="<?php echo $this->get_field_id('divider_bdr'); ?>"><?php _e('Divider Type', 'econature'); ?>:<br />
				<select class="widefat" id="<?php echo $this->get_field_id('divider_bdr'); ?>" name="<?php echo $this->get_field_name('divider_bdr'); ?>">
					<option value="solid"<?php if ($divider_bdr == 'solid') { echo ' selected="selected"'; } ?>><?php _e('Solid Line', 'econature'); ?></option>
					<option value="dashed"<?php if ($divider_bdr == 'dashed') { echo ' selected="selected"'; } ?>><?php _e('Dashed Line', 'econature'); ?></option>
					<option value="dotted"<?php if ($divider_bdr == 'dotted') { echo ' selected="selected"'; } ?>><?php _e('Dotted Line', 'econature'); ?></option>
					<option value="transparent"<?php if ($divider_bdr == 'transparent') { echo ' selected="selected"'; } ?>><?php _e('Transparent Line', 'econature'); ?></option>
				</select>
            </label>
        </p>
		<?php
...
class WP_Widget_Custom_Video extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Video from youtube, vimeo or dailymotion', 'econature') 
		);
		
		parent::__construct('custom-video', __('Embedded Widget', 'econature'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Embedded Widget', 'econature') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('url'); ?>"><?php _e('Embed URL', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('url'); ?>" name="<?php echo $this->get_field_name('url'); ?>" type="text" value="<?php echo $url; ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Max Width', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('width'); ?>" name="<?php echo $this->get_field_name('width'); ?>" type="text" value="<?php echo $width; ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Max Height', 'econature'); ?>:<br />
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('wrap_embed'); ?>"><?php _e('If checked, ignore default video height/max-height and set a 16:9 proportion instead', 'econature'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Facebook extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your Facebook like box', 'econature') 
		);
		
		parent::__construct('custom-facebook', __('Facebook', 'econature'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Facebook', 'econature') : $instance['title'], $instance, $this->id_base);
		$url = isset($instance['url']) ? $instance['url'] : '';
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('url'); ?>"><?php _e('Facebook Page URL', 'econature'); ?> :<br />
                <input class="widefat" id="<?php echo $this->get_field_id('url'); ?>" name="<?php echo $this->get_field_name('url'); ?>" type="text" value="<?php echo $url; ?>" />
            </label>
        </p>
        <div class="cl"></div>
...
class WP_Widget_Custom_Flickr extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your Flickr account latest images', 'econature') 
		);
		
		parent::__construct('custom-flickr', __('Flickr', 'econature'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Flickr', 'econature') : $instance['title'], $instance, $this->id_base);
		...
		echo '<div class="wrap">' . 
			...
			'</div>' . 
			'<div class="cl"></div>' . 
			'<a href="http://www.flickr.com/photos/' . $user . '" class="more_button" target="_blank"><span>' . __('More flickr images', 'econature') . '</span></a>' . 
			'</div>' . 
		$after_widget;
	}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('user'); ?>"><?php _e('Flickr ID', 'econature'); ?> (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):<br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e("Enter the number of latest flickr images you'd like to display", 'econature'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php _e('default is', 'econature'); ?> 6</small><br />
            </label>
        </p>
        <div class="cl"></div>
        <?php
...
class WP_Widget_Custom_HTML5_Audio extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your HTML5 Audio', 'econature') 
		);
		...
		parent::__construct('custom-html5-audio', __('HTML5 Audio', 'econature'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('HTML5 Audio', 'econature') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('srcmp3'); ?>"><?php echo __('Audio', 'econature') . ' .mp3 ' . __('File Format URL', 'econature'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('srcogg'); ?>"><?php echo __('Audio', 'econature') . ' .ogg ' . __('File Format URL', 'econature'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('srcwebm'); ?>"><?php echo __('Audio', 'econature') . ' .webm ' . __('File Format URL', 'econature'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('preload'); ?>"><?php _e('Preload', 'econature'); ?>:<br />
				<select class="widefat" id="<?php echo $this->get_field_id('preload'); ?>" name="<?php echo $this->get_field_name('preload'); ?>">
					<option value="none"<?php if ($preload == 'none') { echo ' selected="selected"'; } ?>><?php _e('Not Preload', 'econature'); ?></option>
					<option value="auto"<?php if ($preload == 'auto') { echo ' selected="selected"'; } ?>><?php _e('Preload Auto', 'econature'); ?></option>
					<option value="metadata"<?php if ($preload == 'metadata') { echo ' selected="selected"'; } ?>><?php _e('Preload as Metadata', 'econature'); ?></option>
				</select>
            </label>
        </p>
		<p class="l_half">
			...
			<label for="<?php echo $this->get_field_id('autoplay'); ?>"><?php _e('Enable Autoplay', 'econature'); ?></label>
		</p>
		<p class="r_half">
			...
			<label for="<?php echo $this->get_field_id('loop'); ?>"><?php _e('Enable Repeat', 'econature'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_HTML5_Video extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your HTML5 Video', 'econature') 
		);
		...
		parent::__construct('custom-html5-video', __('HTML5 Video', 'econature'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('HTML5 Video', 'econature') : $instance['title'], $instance, $this->id_base);
        $srcmp4 = isset($instance['srcmp4']) ? $instance['srcmp4'] : '';
        $srcogg = isset($instance['srcogg']) ? $instance['srcogg'] : '';
        $srcwebm = isset($instance['srcwebm']) ? $instance['srcwebm'] : '';
        $poster = isset($instance['poster']) ? $instance['poster'] : '';
        $text = (isset($instance['text']) && $instance['text'] != '') ? $instance['text'] : __('Your browser does not support the video tag.', 'econature');
        $preload = isset($instance['preload']) ? $instance['preload'] : 'none';
        $loop = isset($instance['loop']) ? $instance['loop'] : false;
        $autoplay = isset($instance['autoplay']) ? $instance['autoplay'] : false;
    ...
    function form($instance) {
		...
		$text = (isset($instance['text']) && $instance['text'] != '') ? esc_attr($instance['text']) : __('Your browser does not support the video tag.', 'econature');
		$preload = isset($instance['preload']) ? esc_attr($instance['preload']) : 'none';
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('srcmp4'); ?>"><?php echo __('Video', 'econature') . ' .mp4 ' . __('File Format Source', 'econature'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('srcogg'); ?>"><?php echo __('Video', 'econature') . ' .ogg ' . __('File Format Source', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('srcogg'); ?>" name="<?php echo $this->get_field_name('srcogg'); ?>" type="text" value="<?php echo $srcogg; ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('srcwebm'); ?>"><?php echo __('Video', 'econature') . ' .webm ' . __('File Format Source', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('srcwebm'); ?>" name="<?php echo $this->get_field_name('srcwebm'); ?>" type="text" value="<?php echo $srcwebm; ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('poster'); ?>"><?php _e('Poster URL', 'econature'); ?>:<br />
...
class WP_Widget_Custom_Latest_Projects extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('type'); ?>"><?php _e('Show Only from Projects Type', 'econature'); ?>:<br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e("Enter the number of latest projects you'd like to display", 'econature'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
		...
		<p>
			<input class="checkbox" type="checkbox" <?php checked($instance['autoplay'], true); ?> id="<?php echo $this->get_field_id('autoplay'); ?>" name="<?php echo $this->get_field_name('autoplay'); ?>" /> 
			<label for="<?php echo $this->get_field_id('autoplay'); ?>"><?php _e('Autoplay', 'econature'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Popular_Projects extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e("Enter the number of popular projects you'd like to display", 'econature'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php _e('default is', 'econature'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Posts_Tabs extends WP_Widget {
    ...
    function form($instance) {
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('latest'); ?>"><?php _e('Latest Posts', 'econature'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('popular'); ?>"><?php _e('Popular Posts', 'econature'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('recent'); ?>"><?php _e('Recent Comments', 'econature'); ?></label>
		</p>
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e("Enter the number of recent comments, popular and latest posts you'd like to display", 'econature'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php _e('default is', 'econature'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Twitter extends WP_Widget {
			...
			if ($tweets != '') {
				...
				echo '<div class="cmsms_notice cmsms_notice_error cmsms-icon-cancel-6">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . __('Please add your Twitter API keys', 'econature') . ', ' . '<a target="_blank" href="http://docs.cmsmasters.net/admin2/twitter-functionality/">' . __('read more how', 'econature') . '</a></p>' . "\n" . 
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('user'); ?>"><?php _e('Twitter Username', 'econature'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('user'); ?>" name="<?php echo $this->get_field_name('user'); ?>" type="text" value="<?php echo $user; ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e("Enter the number of latest tweets you'd like to display", 'econature'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php _e('default is', 'econature'); ?> 3</small><br />
            </label>
        </p>
