...
<article id="post-<?php the_ID(); ?>" <?php post_class($cmsms_project_size); echo (($project_categs != '') ? ' data-category="' . $project_categs . '"' : '') ?>>
	...
	<?php 
		cmsms_thumb_rollover(get_the_ID(), $project_img_size, $rollover, true, true, $cmsms_project_images, false, false, false, false, true, $cmsms_project_link_redirect, $cmsms_project_link_url);
