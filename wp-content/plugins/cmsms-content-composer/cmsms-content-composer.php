...
define('CMSMS_CONTENT_COMPOSER_VERSION', '1.3.3');
...
class Cmsms_Content_Composer { 
	function __construct() { 
		...
		register_activation_hook(__FILE__, array($this, 'cmsms_content_composer_activate_deactivate'));
		
		register_deactivation_hook(__FILE__, array($this, 'cmsms_content_composer_activate_deactivate'));
	...
	function cmsms_composer_enqueue_scripts($hook) {
		...
		wp_register_script('jquery-base64', CMSMS_CONTENT_COMPOSER_URL . 'framework/js/jquery.base64.min.js', array('jquery'), '1.0.0', true);
